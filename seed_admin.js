...
async function seed() {
  const colRef = db.collection('opportunities');
  console.log('Seeding started via Admin SDK...');
  
  for (const op of opportunities) {
    op.postedAt = FieldValue.serverTimestamp();
    const docRef = await colRef.add(op);
